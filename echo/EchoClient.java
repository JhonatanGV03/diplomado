...
public class EchoClient {
	...
	public EchoClient() {
		...
		System.out.println("Other usage: EchoClient host port. Ex: EchoClient localhost 3400");
	}
	...
	public void protocol(Socket socket) throws Exception {
		...
		System.out.println("[Cliente] From server: " + fromServer);

		System.out.println("[Cliente] Finished.");
	}
